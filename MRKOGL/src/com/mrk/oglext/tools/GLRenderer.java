...
public class GLRenderer implements GLSurfaceView.Renderer {
	...
	public void onSurfaceCreated(GL10 gl, EGLConfig config) {
		...
		MRKOGL.getInstance().graphics.lastFrameTime = 0;
	...
	public void onDrawFrame(GL10 gl) {
		...
		MRKOGL.getInstance().graphics.lastFrameTime = (int) (currentTime - lastTime);
...
//		scene.draw(gl);
		if (itf != null) itf.render(gl, MRKOGL.getInstance().graphics.lastFrameTime);
	}
